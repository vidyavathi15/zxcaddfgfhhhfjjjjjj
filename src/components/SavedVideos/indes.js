...
import {SavedVideosBgContainer, SavedListContainer} from './styledComponents'
    ...
    {value => {
      ...
      return (
          {showNoVideosView ?  (
              ...
              <NoSavedVideosStatus>You can see your videos while watching them</NoSavedVideosStatus>
            </NoSavedVideosContainer>
